...
namespace ResolveBot.Dialogs
{
    ...
    public class ExceptionHandlerDialog<T> : IDialog<object>
    {
        ...
        private ResolveBotDialog resolveBotDialog;
        ...
        public ExceptionHandlerDialog(ResolveBotDialog resolveBotDialog, bool displayException)
        {
            this.resolveBotDialog = resolveBotDialog;
